...
public class RemoteUtil {
	...
	public void init() {
		...
		this.host = propertiesUtil.readPropertyByKey(Property.HOST_NAME.toString());
		this.userName = propertiesUtil.readPropertyByKey(Property.SERVER_USER.toString());
		this.userPwd = propertiesUtil.readPropertyByKey(Property.SERVER_PWD.toString());
	}
